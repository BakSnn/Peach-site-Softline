(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&t(a)}).observe(document,{childList:!0,subtree:!0});function i(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(e){if(e.ep)return;e.ep=!0;const o=i(e);fetch(e.href,o)}})();const f="/Peach-site-Softline/assets/logo-DojQXc68.svg",m=document.querySelector(".header");function u(){m&&(m.innerHTML=`
    ...
    `)}u();const _=document.querySelector(".about-company");function w(){_&&(_.innerHTML=`
    ...
    `)}B();const L="/Peach-site-Softline/assets/SoftlineSolutions-GaHIEMpC.png",S="/Peach-site-Softline/assets/Cybersecurity-Bfk6VWzo.png",x="/Peach-site-Softline/assets/ImportSubstitution-CfVA4aNY.png",M="/Peach-site-Softline/assets/CloudSolutions-U6kQu8Aw.png",$="/Peach-site-Softline/assets/DigitalTransformation-D9KZGsH_.png",D="/Peach-site-Softline/assets/TechnicalSupport-B-qi6sXc.png",h=document.querySelector(".business-directions");function H(){h&&(h.innerHTML=`
      <div class="business-direction__container">
        ...
        <div class="business-direction__grid">
          ...
          <div class="business-direction__item">
            <img class="business-direction__image" src="${D}" alt="Technical support">
      ...
      <div class="compensation__container">
        ...
        <div class="compensation__program">
          ...
          <div class="compensation__program__items">
            ...
            <div class="compensation__program__item">
              <div class="compensation__item-circle">
                <img class="compensation__item" src="${T}" />
              </div>
    ...
    `)}O();const Z="/Peach-site-Softline/assets/%D0%A1%D0%BB%D0%B0%D0%B9%D0%B41-Bn9SUNAu.png",j="/Peach-site-Softline/assets/%D0%A1%D0%BB%D0%B0%D0%B9%D0%B42-C1lCdgUF.png",F="/Peach-site-Softline/assets/%D0%A1%D0%BB%D0%B0%D0%B9%D0%B43-7jBdRtQ1.png",N="/Peach-site-Softline/assets/%D0%A1%D0%BB%D0%B0%D0%B9%D0%B44-DrY9oOWZ.png",R="/Peach-site-Softline/assets/%D0%A1%D0%BB%D0%B0%D0%B9%D0%B45-Ckd1qRr4.png",z="data:image/svg+xml,%3csvg%20width='56'%20height='56'%20viewBox='0%200%2056%2056'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3crect%20width='56'%20height='56'%20rx='28'%20transform='matrix(-1%200%200%201%2056%200)'%20fill='%23F0F0F0'/%3e%3cpath%20d='M33%2018L23%2028L33%2038'%20stroke='%23A30C33'%20stroke-width='2'/%3e%3c/svg%3e",Q="data:image/svg+xml,%3csvg%20width='56'%20height='56'%20viewBox='0%200%2056%2056'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3crect%20width='56'%20height='56'%20rx='28'%20fill='%23F0F0F0'/%3e%3cpath%20d='M23%2018L33%2028L23%2038'%20stroke='%23A30C33'%20stroke-width='2'/%3e%3c/svg%3e";function U(){const n=document.querySelector(".corporate-life");if(n){let c=function(d){i.forEach((l,r)=>{l.classList.toggle("active",r===d)}),t.forEach((l,r)=>{l.classList.toggle("active",r===d)})};var s=c;n.innerHTML=`
      <div class="corporate__container">
        <div class="corporate__arrow">
          ...
          <button class="arrow left-arrow">
            <img src="${z}" alt="Left Arrow">
          </button>
          <button class="arrow right-arrow">
            <img src="${Q}" alt="Right Arrow">
          </button>
        </div>

        <div class="gallery">
          <div class="gallery__images">
            <img src="${Z}" alt="Image1" class="gallery__image active">
            <img src="${j}" alt="Image2" class="gallery__image">
            <img src="${F}" alt="Image3" class="gallery__image">
    ...
    `;const i=n.querySelectorAll(".gallery__image"),t=n.querySelectorAll(".dot"),e=n.querySelector(".left-arrow"),o=n.querySelector(".right-arrow");let a=0;e.addEventListener("click",()=>{a=a>0?a-1:i.length-1,c(a)}),o.addEventListener("click",()=>{a=a<i.length-1?a+1:0,c(a)})}}U();
